---
description: Check for GSD updates via npm, display changelog for versions between installed and latest, obtain u
---
<purpose>
...
if [ -f "./.claude/get-shit-done/VERSION" ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/satori/.antigravity/get-shit-done/VERSION ]; then
  cat /Users/satori/.antigravity/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/satori/.antigravity/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/satori/.antigravity/cache/gsd-update-check.json
```
</step>
