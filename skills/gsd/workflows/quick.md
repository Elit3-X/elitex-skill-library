---
description: Execute small, ad-hoc tasks with GSD guarantees (atomic commits, STATE.md tracking) while skipping o
---
<purpose>
...
```bash
INIT=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js init quick "$DESCRIPTION")
```
...
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js commit "docs(quick-${next_num}): ${DESCRIPTION}" --files ${QUICK_DIR}/${next_num}-PLAN.md ${QUICK_DIR}/${next_num}-SUMMARY.md .planning/STATE.md
```
