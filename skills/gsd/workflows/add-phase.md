---
description: Add a new integer phase to the end of the current milestone in the roadmap. Automatically calculates
---
<purpose>
...
```bash
INIT=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js init phase-op "0")
```
