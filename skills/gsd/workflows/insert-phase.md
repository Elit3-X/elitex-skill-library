---
description: Insert a decimal phase for urgent work discovered mid-milestone between existing integer phases. Use
---
<purpose>
...
```bash
INIT=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js init phase-op "${after_phase}")
```
...
```bash
DECIMAL_INFO=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js phase next-decimal "${after_phase}")
```
...
```bash
slug=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js generate-slug "$description" --raw)
```
