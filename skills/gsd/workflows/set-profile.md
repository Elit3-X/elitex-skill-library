---
description: Switch the model profile used by GSD agents. Controls which Claude model each agent uses, balancing 
---
<purpose>
...
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js config-ensure-section
INIT=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js state load)
```
