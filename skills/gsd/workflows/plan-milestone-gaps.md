---
description: Create all phases necessary to close gaps identified by `/gsd:audit-milestone`. Reads MILESTONE-AUDI
---
<purpose>
...
PHASES=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js phases list)
...
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md
```
