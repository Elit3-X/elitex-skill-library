---
description: GSD Workflow: complete-milestone
---
<purpose>
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js summary-extract "$summary" --fields one_liner | jq -r '.one_liner'
done
```
...
2. Read `/Users/satori/.antigravity/get-shit-done/templates/milestone-archive.md` template
...
```bash
INIT=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js init execute-phase "1")
```
...
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js commit "chore: complete v[X.Y] milestone" --files .planning/milestones/v[X.Y]-ROADMAP.md .planning/milestones/v[X.Y]-REQUIREMENTS.md .planning/milestones/v[X.Y]-MILESTONE-AUDIT.md .planning/MILESTONES.md .planning/PROJECT.md .planning/STATE.md
```
```
