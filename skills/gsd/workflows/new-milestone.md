---
description: GSD Workflow: new-milestone
---
<purpose>
...
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js commit "docs: start milestone v[X.Y] [Name]" --files .planning/PROJECT.md .planning/STATE.md
```

## 7. Load Context and Resolve Models

```bash
INIT=$(node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js init new-milestone)
```
...
Use template: /Users/satori/.antigravity/get-shit-done/templates/research-project/{FILE}
</output>
...
**Commit requirements:**
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js commit "docs: define milestone v[X.Y] requirements" --files .planning/REQUIREMENTS.md
```
...
```bash
node /Users/satori/.antigravity/get-shit-done/bin/gsd-tools.js commit "docs: create milestone v[X.Y] roadmap ([N] phases)" --files .planning/ROADMAP.md .planning/STATE.md .planning/REQUIREMENTS.md
```
