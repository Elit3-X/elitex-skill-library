...
```
Task(
  prompt="Read /Users/satori/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/satori/.claude/get-shit-done/templates/VALIDATION.md`
